<template>
    <div class="view-wrap">
        ...
        <scroller class="view-inner">
            <!--上拉刷新-->
            <refresh class="view-refresh" @refresh="refreshHandle" @pullingdown="pullingDownHandle" :display="refreshing ? 'show' : 'hide'">
        ...
        V25.379L3.102,6.731C2.643,6.189,3.018,5.354,3.727,5.354h36.504C40.94,5.354,41.357,6.189,40.899,6.731L40.899,6.731z"/>
            ...
            <!--下拉刷新-->
            <loading class="view-loading" @loading="loadingHandle" :display="showLoading">
